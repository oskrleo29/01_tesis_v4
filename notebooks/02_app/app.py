...
# Título con sufijo v2 para distinguir de la app original
# ----------------------------------------------------------
st.set_page_config(
    page_title="Estimador de Gasto Personal v2",
    page_icon="💳",
    layout="centered",
)

# Indicador visual de versión — confirma que es la nueva arquitectura
st.markdown(
    """
    <div style="
    ...
    ">
        ✦ v2 — Nueva arquitectura · notebooks/02_app/ · artefacto: notebooks/artefactos_modelo_hibrido.pkl
    </div>
    """,
    unsafe_allow_html=True,
)

st.title("Estimador de Gasto Personal y Perfil de Consumo v2")
st.markdown("""
...
if submitted:
    ...
    try:
        ...
        st.caption(
            ...
            "— v2 · arquitectura notebooks/02_app/"
        )
